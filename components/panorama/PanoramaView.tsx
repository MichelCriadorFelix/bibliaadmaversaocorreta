            ...
            <main className="max-w-7xl mx-auto px-3 sm:px-6 pt-32">
                ...
                {(activeTab !== 'thematic' && activeTab !== 'quiz' || (activeTab === 'thematic' && thematicViewMode === 'lesson_content')) && (
                    <PanoramaAdminPanel 
                        ...
                        handleGenerate={activeTab === 'thematic' ? handleGenerateThematic : () => generateEbd(book, chapter, customInstructions, theologicalDensity, activeTab as 'student' | 'teacher', depthLevel, targetPages, thinkingLevel)}
                        ...
                        chapterRelevanceWeight={chapterRelevanceWeight}
                        setChapterRelevanceWeight={setChapterRelevanceWeight}
                        activeTab={activeTab}
