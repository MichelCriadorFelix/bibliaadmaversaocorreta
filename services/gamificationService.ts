...
// 36 Conquistas detalhadas com critérios e raridades (agora expandido para 47 conquistas)
export const ACHIEVEMENTS: Achievement[] = [
    ...
    },
    {
        id: 'read_10_chapters',
        title: 'Leitor Fiel',
        description: 'Complete 10 capítulos lidos na Bíblia.',
        category: 'reading',
        tier: 'bronze',
        iconName: 'BookOpen',
        xpReward: 100,
        checkUnlocked: (s) => s.chaptersRead >= 10,
        progressCalc: (s) => ({ current: Math.min(s.chaptersRead, 10), total: 10 }),
    },
    {
        id: 'read_genesis',
        title: 'No Princípio',
    ...
    {
        id: 'read_250_chapters',
        title: 'Buscador de Tesouros',
        description: 'Complete 250 capítulos lidos.',
        category: 'reading',
        tier: 'silver',
        iconName: 'Search',
        xpReward: 350,
        checkUnlocked: (s) => s.chaptersRead >= 250,
        progressCalc: (s) => ({ current: Math.min(s.chaptersRead, 250), total: 250 }),
    },
    {
    ...
    {
        id: 'read_800_chapters',
        title: 'Peregrino do Verbo',
        description: 'Complete 800 capítulos lidos.',
        category: 'reading',
        tier: 'gold',
        iconName: 'Award',
        xpReward: 1500,
        checkUnlocked: (s) => s.chaptersRead >= 800,
        progressCalc: (s) => ({ current: Math.min(s.chaptersRead, 800), total: 800 }),
    },
    {
    ...
    {
        id: 'ebd_10',
        title: 'Discípulo do Mestre',
        description: 'Complete 10 estudos profundos da EBD Panorama.',
        category: 'ebd',
        tier: 'bronze',
        iconName: 'Scroll',
        xpReward: 200,
        checkUnlocked: (s) => s.ebdRead >= 10,
        progressCalc: (s) => ({ current: Math.min(s.ebdRead, 10), total: 10 }),
    },
    {
        id: 'ebd_20',
    ...
    {
        id: 'ebd_30',
        title: 'Investigador Teológico',
        description: 'Complete 30 estudos profundos da EBD.',
        category: 'ebd',
        tier: 'silver',
        iconName: 'Search',
        xpReward: 600,
        checkUnlocked: (s) => s.ebdRead >= 30,
        progressCalc: (s) => ({ current: Math.min(s.ebdRead, 30), total: 30 }),
    },
    {
        id: 'ebd_50',
        title: 'Mestre da EBD',
    ...
    {
        id: 'thematic_5',
        title: 'Sondador de Mistérios',
        description: 'Conclua 5 aulas temáticas especiais.',
        category: 'thematic',
        tier: 'bronze',
        iconName: 'BookOpen',
        xpReward: 150,
        checkUnlocked: (s) => s.thematicRead >= 5,
        progressCalc: (s) => ({ current: Math.min(s.thematicRead, 5), total: 5 }),
    },
    {
        id: 'thematic_10',
    ...
    {
        id: 'thematic_20',
        title: 'Doutrinador Zeloso',
        description: 'Conclua 20 aulas temáticas especiais.',
        category: 'thematic',
        tier: 'silver',
        iconName: 'Award',
        xpReward: 500,
        checkUnlocked: (s) => s.thematicRead >= 20,
        progressCalc: (s) => ({ current: Math.min(s.thematicRead, 20), total: 20 }),
    },
    {
        id: 'thematic_30',
    ...
    {
        id: 'thematic_50',
        title: 'Mestre de Apologética',
        description: 'Conclua 50 aulas temáticas especiais.',
        category: 'thematic',
        tier: 'gold',
        iconName: 'Crown',
        xpReward: 1200,
        checkUnlocked: (s) => s.thematicRead >= 50,
        progressCalc: (s) => ({ current: Math.min(s.thematicRead, 50), total: 50 }),
    },
    ...
    {
        id: 'quiz_10_taken',
        title: 'Praticante Assíduo',
        description: 'Complete 10 quizzes de fixação bíblica.',
        category: 'quiz',
        tier: 'bronze',
        iconName: 'BookOpen',
        xpReward: 200,
        checkUnlocked: (s) => s.quizzesCompleted >= 10,
        progressCalc: (s) => ({ current: Math.min(s.quizzesCompleted, 10), total: 10 }),
    },
    {
        id: 'quiz_50_pts',
    ...
    {
        id: 'quiz_100_pts',
        title: 'Estudioso das Letras',
        description: 'Acumule 100 pontos no Quiz bíblico.',
        category: 'quiz',
        tier: 'bronze',
        iconName: 'Book',
        xpReward: 300,
        checkUnlocked: (s) => s.quizPoints >= 100,
        progressCalc: (s) => ({ current: Math.min(s.quizPoints, 100), total: 100 }),
    },
    {
        id: 'quiz_200_pts',
    ...
    {
        id: 'quiz_300_pts',
        title: 'Investigador da Palavra',
        description: 'Acumule 300 pontos respondendo quizzes.',
        category: 'quiz',
        tier: 'silver',
        iconName: 'Search',
        xpReward: 600,
        checkUnlocked: (s) => s.quizPoints >= 300,
        progressCalc: (s) => ({ current: Math.min(s.quizPoints, 300), total: 300 }),
    },
    {
        id: 'quiz_500_pts',
    ...
    },
    {
        ...
        description: 'Dispute 10 duelos na Arena ADMA.',
        category: 'duel',
        tier: 'bronze',
        iconName: 'Shield',
        xpReward: 250,
        checkUnlocked: (s) => s.duelMatches >= 10,
        progressCalc: (s) => ({ current: Math.min(s.duelMatches, 10), total: 10 }),
    },
    {
        id: 'duel_10_wins',
        title: 'Espada da Verdade',
        description: 'Conquiste 10 vitórias em duelos da Arena ADMA.',
        category: 'duel',
        tier: 'silver',
        iconName: 'Flame',
        xpReward: 400,
        checkUnlocked: (s) => s.duelWins >= 10,
        progressCalc: (s) => ({ current: Math.min(s.duelWins, 10), total: 10 }),
    },
    {
        id: 'duel_15_wins',
    ...
    {
        id: 'duel_25_wins',
        title: 'Soberano da Arena',
        description: 'Conquiste 25 vitórias em duelos da Arena ADMA.',
        category: 'duel',
        tier: 'gold',
        iconName: 'Award',
        xpReward: 1000,
        checkUnlocked: (s) => s.duelWins >= 25,
        progressCalc: (s) => ({ current: Math.min(s.duelWins, 25), total: 25 }),
    },
    {
        id: 'duel_50_wins',
    ...
    {
        id: 'plan_3_finishers',
        title: 'Inabalável no Caminho',
        description: 'Conclua com sucesso 3 Planos de Leitura Bíblica.',
        category: 'special',
        tier: 'gold',
        iconName: 'Award',
        xpReward: 700,
        checkUnlocked: (s) => s.plansCompleted >= 3,
        progressCalc: (s) => ({ current: Math.min(s.plansCompleted, 3), total: 3 }),
    },
    {
    ...
    {
        id: 'highlighter_50',
        title: 'Farol das Escrituras',
        description: 'Marque ou destaque 50 versículos bíblicos.',
        category: 'special',
        tier: 'silver',
        iconName: 'Sun',
        xpReward: 300,
        checkUnlocked: (s) => s.highlightsCount >= 50,
        progressCalc: (s) => ({ current: Math.min(s.highlightsCount, 50), total: 50 }),
    },
    {
        id: 'highlighter_100',
        title: 'Iluminador Profissional',
        description: 'Marque ou destaque 100 versículos bíblicos.',
        category: 'special',
        tier: 'gold',
        iconName: 'Crown',
        xpReward: 600,
        checkUnlocked: (s) => s.highlightsCount >= 100,
        progressCalc: (s) => ({ current: Math.min(s.highlightsCount, 100), total: 100 }),
    },
    {
        id: 'attendance_gold',
    ...
    {
        id: 'attendance_25',
        title: 'Pilar da Congregação',
        description: 'Acumule 25 presenças registradas na Escola Bíblica Dominical.',
        category: 'special',
        tier: 'diamond',
        iconName: 'Crown',
        xpReward: 1500,
        checkUnlocked: (s) => s.attendanceCount >= 25,
        progressCalc: (s) => ({ current: Math.min(s.attendanceCount, 25), total: 25 }),
    },
];
